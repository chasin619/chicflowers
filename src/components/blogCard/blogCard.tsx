...
const BlogCard: React.FC<BlogCardProps> = ({
  ...
  return (
    <Link href={`/blog/${slug}`}>
      <div className="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto cursor-pointer transition-all transform hover:scale-[1.02] duration-300 ease-in-out hover:shadow-lg">
