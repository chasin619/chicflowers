...
export async function POST(request: Request) {
  ...
  const mailOptions = {
    ...
    html: `
      ...
      <p><strong>Wedding Investment:</strong> ${financialInfo.weddingInvestment}</p>
      ...
      <p><strong>Preferred Contact Type:</strong> ${additionalInfo.contactType}</p>
      ...
      <p><strong>Permission to Share Pictures:</strong> ${additionalInfo.sharePicture}</p>
      <p><strong>How Did You Hear About Us:</strong> ${additionalInfo.hearAbout}</p>
