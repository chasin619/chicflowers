...
const RecordSection = () => {
  return (
    <div className="w-full lg:px-20 lg:py-28 mobile:px-4 mobile:py-20 lg:mt-[2000px] mobile:mt-[500px]">
      ...
      <p className="lg:text-xl mobile:text-base font-medium text-left mt-2 lg:w-[900px] mobile:w-90">
        Nobody does a sprint better than Birch. We can pull off in days what it
      ...
      <div className="flex items-center lg:gap-20 mobile:gap-4">
        <div className="flex lg:gap-20 mobile:gap-16 flex-col w-20">
          ...
          <p className="rotate-90 text-[12px]">BIRCH</p>
        </div>
        <Slider />
      </div>
    </div>
